...
namespace Continuous\Swf\DataTypes;
...
final class Event
{
    ...
    const LAMBDA_FUNCTION_SCHEDULED = 'LambdaFunctionScheduled';
    const LAMBDA_FUNCTION_STARTED = 'LambdaFunctionStarted';
    const LAMBDA_FUNCTION_COMPLETED = 'LambdaFunctionCompleted';
    const LAMBDA_FUNCTION_FAILED = 'LambdaFunctionFailed';
    const LAMBDA_FUNCTION_TIMED_OUT = 'LambdaFunctionTimedOut';
    const SCHEDULE_LAMBDA_FUNCTION_FAILED = 'ScheduleLambdaFunctionFailed';
    const START_LAMBDA_FUNCTION_FAILED = 'StartLambdaFunctionFailed';
}
